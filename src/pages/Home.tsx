    ...
    >
      ...
      <section className="py-24 md:py-28 px-6 bg-brand-warm-gray relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
            ...
            <h2 className="text-5xl md:text-6xl font-serif mb-20 tracking-tighter italic text-center">Spremljajte nas v živo</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full">
               ...
               <div className="bg-white rounded-[60px] p-8 md:p-12 luxury-shadow min-h-[600px] flex flex-col items-center justify-center border border-brand-wood/5 group relative overflow-hidden transition-all duration-700 hover:scale-[1.01]">
                  ...
                  <button type="button" disabled title="Povezava do profila bo dodana v končni različici" className="text-[9px] uppercase tracking-widest font-black text-brand-stone/40 py-2 cursor-not-allowed">Obiščite naš profil</button>
               </div>
               ...
               <div className="bg-white rounded-[60px] p-8 md:p-12 luxury-shadow min-h-[600px] flex flex-col items-center justify-center border border-brand-wood/5 group relative overflow-hidden transition-all duration-700 hover:scale-[1.01]">
                  ...
                  <button type="button" disabled title="Povezava do strani bo dodana v končni različici" className="text-[9px] uppercase tracking-widest font-black text-brand-stone/40 py-2 cursor-not-allowed">Pridružite se nam na FB</button>
               </div>
            </div>
        </div>
      </section>
