...
export default function Home() {
  useSeo(
    'Pod Slavnikom | Gostišče s prenočišči & Wellness',
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-[#2a1d15]">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl py-16 md:py-20">
           {/* Logo / Illustration */}
           <motion.div
           ...
           >
              <div className="flex flex-col items-center justify-center space-y-6">
                <div className="space-y-6 mt-4">
                  ...
                  <h1 className="text-5xl sm:text-6xl md:text-8xl uppercase tracking-normal font-serif font-black text-brand-cream leading-[0.85] filter drop-shadow-sm pt-4">
                    Pod Slavnikom
                  </h1>
                  <p className="script-font text-3xl sm:text-4xl md:text-6xl text-brand-gold/90 transition-transform duration-700">Tradicija od leta 1993</p>
                </div>
              </div>
           </motion.div>
        ...
        {/* Scroll Indicator — hidden on small screens to avoid crowding the hero controls */}
      ...
      <section className="py-24 md:py-28 px-6 bg-brand-wood text-brand-cream relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row-reverse gap-24 items-center">
           ...
           <div className="lg:w-1/2">
              ...
              <div className="w-20 h-[1px] bg-brand-gold mb-10"></div>
              <p className="text-brand-cream/60 text-xl mb-12 leading-relaxed font-serif max-w-xl">
        ...
        <div className="max-w-5xl mx-auto">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                 ...
                 <h2 className="text-5xl md:text-6xl font-serif mb-12 tracking-tighter italic">Izkusite <br/> mir.</h2>
                 <div className="space-y-8 text-brand-stone text-lg leading-relaxed font-serif">
      ...
      <section className="py-24 md:py-28 px-6 bg-brand-wood text-brand-cream relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-24 items-center relative z-10">
           ...
           <div className="lg:w-1/2">
              ...
              <p className="text-brand-cream/80 text-xl mb-10 leading-relaxed font-serif font-light">
              ...
              <div className="space-y-8 text-brand-cream/60 text-lg leading-relaxed font-serif">
      ...
      {/* Host Bio - Igor */}
      <section className="py-28 md:py-32 px-6 bg-brand-cream relative overflow-hidden">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center relative z-10">
           <div className="w-56 h-56 md:w-64 md:h-64 rounded-full overflow-hidden mb-16 luxury-shadow border-4 border-white group">
              <img src="/images/client/people/igor-cendak-portrait.webp" className="w-full h-full object-cover object-top grayscale group-hover:grayscale-0 transition-all duration-1000" alt="Igor Čendak" referrerPolicy="no-referrer" loading="lazy" decoding="async" />
           </div>
           <span className="text-brand-gold text-[10px] uppercase tracking-[0.6em] font-bold block mb-8 font-display">Vaš gostitelj</span>
           <h3 className="text-5xl md:text-6xl font-serif mb-12 italic tracking-tighter">"Iskrena skrb za <br/> vsakega gosta."</h3>
           <div className="space-y-8 text-brand-stone text-xl leading-relaxed font-serif max-w-2xl">
      ...
      <section className="py-28 md:py-32 px-6 bg-brand-cream relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-24">
            ...
            <h2 className="text-5xl md:text-6xl font-serif italic tracking-tighter leading-none mb-6">Mnenja naših gostov</h2>
      ...
      <section className="py-0 px-0 bg-brand-cream relative">
        <div className="w-full h-[600px] relative group">
          ...
          <div className="absolute bottom-10 right-10 p-12 bg-brand-wood/90 backdrop-blur-xl text-brand-cream rounded-[60px] luxury-shadow border border-white/5 max-w-sm hidden md:block">
            ...
            <h3 className="text-3xl font-serif italic mb-6 leading-tight">Podgorje 1, <br />6216 Podgorje</h3>
      ...
      <section className="py-24 md:py-28 px-6 bg-brand-warm-gray relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
            ...
            <h2 className="text-5xl md:text-6xl font-serif mb-20 tracking-tighter italic text-center">Povežite se z nami</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full">
               ...
               <a
                 ...
                 className="bg-white rounded-[60px] p-8 md:p-12 luxury-shadow min-h-[600px] flex flex-col items-center justify-center border border-brand-wood/5 group relative overflow-hidden transition-all duration-700 hover:scale-[1.01] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-gold"
               >
                  <div className="absolute inset-0 opacity-[0.03] pointer-events-none grain-texture"></div>
                  <div className="mb-12 flex flex-col items-center gap-6">
                     <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] p-1 scale-90 group-hover:scale-100 transition-transform duration-700">
                        <div className="w-full h-full rounded-full bg-white flex items-center justify-center text-brand-wood">
                           <svg viewBox="0 0 24 24" className="w-10 h-10 fill-current" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.058-1.69-.072-4.949-.072zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                        </div>
                     </div>
                     <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-brand-gold font-display">@podslavnikom</span>
                  </div>
                  <div className="w-full text-center italic font-serif text-brand-stone/60 mb-12 flex-1 flex items-center justify-center p-12 border-2 border-dashed border-brand-wood/10 rounded-[40px]">
                     Spremljajte nas na Instagramu za utrinke iz gostilne, sob in wellnessa.
                  </div>
                  <span className="text-[9px] uppercase tracking-widest font-black text-brand-gold py-2 group-hover:underline">Obiščite naš profil</span>
               </a>
                  ...
                  <div className="mb-12 flex flex-col items-center gap-6">
                     <div className="w-24 h-24 rounded-full bg-[#1877F2] p-1 scale-90 group-hover:scale-100 transition-transform duration-700">
                        <div className="w-full h-full rounded-full bg-white flex items-center justify-center text-[#1877F2]">
                           <svg viewBox="0 0 24 24" className="w-10 h-10 fill-current" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.312h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/></svg>
                        </div>
                     </div>
                     <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#1877F2] font-display">Facebook stran</span>
                  </div>
                  <div className="w-full text-center italic font-serif text-brand-stone/60 mb-12 flex-1 flex items-center justify-center p-12 border-2 border-dashed border-brand-wood/10 rounded-[40px]">
                     Obiščite nas na Facebooku za novice, dogodke in ponudbe.
                  </div>
                  <span className="text-[9px] uppercase tracking-widest font-black text-[#1877F2] py-2 group-hover:underline">Pridružite se nam na FB</span>
               </a>
            </div>
        </div>
      </section>
